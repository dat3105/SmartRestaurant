...
public class AdapterPopularDrink extends RecyclerView.Adapter<AdapterPopularDrink.ViewHolder> {
    RootObject drinkList;
    Context context;

    public AdapterPopularDrink(RootObject drinkList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.view_popular_drink,viewGroup,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            drinkname    = itemView.findViewById(R.id.tvDrinkPFood);
            price       = itemView.findViewById(R.id.tvPrice);
            imgdrink = itemView.findViewById(R.id.img_popular_drink);
        }
    }
}
