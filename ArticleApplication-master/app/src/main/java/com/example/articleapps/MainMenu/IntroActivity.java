...
import com.example.articleapps.AdapterMainMenu.AdapterIntroViewPager;
...
public class IntroActivity extends AppCompatActivity {
    ...
    Integer imgIntro[]={
      R.drawable.article1,
      R.drawable.article2,R.drawable.article3,R.drawable.article4,R.drawable.article5,R.drawable.article6
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btGetStarted.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(IntroActivity.this, Activity_Login.class);
                startActivity(i);
                finish();
            }
        });
